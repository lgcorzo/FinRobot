...
from finrobot.infrastructure import services
from finrobot.infrastructure.adapters.mlflow_adapter import CustomLoader
from finrobot.models.schemas import InputsSchema, Outputs
from pandera.typing.common import DataFrameBase
from pydantic import BaseModel

# Constants
DEFAULT_KAFKA_SERVER = os.getenv("DEFAULT_KAFKA_SERVER", "my-kafka-cluster.confluent.svc.cluster.local:9092")
DEFAULT_GROUP_ID = os.getenv("DEFAULT_GROUP_ID", "finrobot-regression")
DEFAULT_AUTO_OFFSET_RESET = os.getenv("DEFAULT_AUTO_OFFSET_RESET", "earliest")
DEFAULT_INPUT_TOPIC = os.getenv("DEFAULT_INPUT_TOPIC", "finrobot_input_topic")
DEFAULT_OUTPUT_TOPIC = os.getenv("DEFAULT_OUTPUT_TOPIC", "finrobot_output_topic")
