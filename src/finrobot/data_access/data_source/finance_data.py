...
from finrobot.data_access.data_source.filings_src import (
    sec_main as unstructured_sec_main,
)
from finrobot.data_access.data_source.marker_sec_src.pdf_to_md import (
    run_marker as run_marker_single,
)
...
def get_data(
    ...
    assert data_source in [
        ...
        "earnings_calls",
        "marker_pdf",
    ], "The valid data sources are ['unstructured','earnings_calls','marker_pdf']"
