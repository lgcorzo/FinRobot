"""SEC Adapter - Filings Repository Implementation."""
...
class SECAdapter:
    """SEC API implementation of FilingsRepository."""
    ...
    def download_10k_filing(
        ...
        metadata = SECAdapter.get_10k_metadata(ticker, start_date, end_date)
        if metadata:
