...
class TestFinanceData:
    ...
    def test_get_data_unstructured(self, mock_unstructured):
    ...
    def test_get_data_earnings_calls(self, mock_get_earnings):
    ...
    def test_get_data_marker_pdf(self, mock_run_marker, mock_save_pdfs):
