...
class TestFinanceData:
    ...
    def test_get_data_unstructured(self, mock_unstructured) -> None:
    ...
    def test_get_data_earnings_calls(self, mock_get_earnings) -> None:
    ...
    def test_get_data_marker_pdf(self, mock_run_marker, mock_save_pdfs) -> None:
